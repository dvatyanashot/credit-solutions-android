...
import com.example.creditsolutions.databinding.FragmentSignUpCodeBinding


class SignUpCode : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.approve.setOnClickListener {
            findNavController().navigate(R.id.action_signUpCode_to_newPasswordCreate)
        }
    }
